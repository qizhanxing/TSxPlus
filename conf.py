...
latex_documents = [
    (master_doc, 'TSxPlus.tex', u'TSxPlus Documentation',
     u'Xiong Neng', 'howto'),
]
...
man_pages = [
    (master_doc, 'TSxPlus', u'TSxPlus Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TSxPlus', u'TSxPlus Documentation',
     author, 'TSxPlus', 'One line description of project.',
     'Miscellaneous'),
]
